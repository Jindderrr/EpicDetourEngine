...
--------------------Ниже-представлены-обновления-связанные-с-движком---------------------

В Version 0.4 добавлено:

Функция 'CircleCollisionMove' теперь в рабочем состоянии
Добавлена функция 'getWallCollisionByTypes', для удобного нахождения колизий нужного типа
Для 'Actor' добавленна возможность создавать свое типы компонентов
Улучшена панель разработчика

=========================================================================================

В Version 0.3.4 добавлено:

Добавлен метод 'Destroy' для Actor, уничтожающий его
Улучшена панель разработчика

=========================================================================================

В Version 0.3.3 добавлено:

Исправлен баг в 'OpenOBJAsMap'

=========================================================================================

В Version 0.3.2 добавлено:

Исправлены баги и другие мелкие уличшения


=========================================================================================

В Version 0.3.1 добавлено:

Полноэкранный режим, качество текстур

Добавлена возможность создавать спрайты через 'OpenOBJAsMap'
Добавлена возможность добавление спрайтов в 'Actor'
Добавлен класс 'Character', для создания персонажей
Переработан класс 'FirstPersonCharacter'
Добавлена функция 'LineTrace', для удобного нахождения точки пересечения луча со стенами
...
getWallCollisionByTypes: функция, которая возвращает коллизии нужного типа

CircleCollisionMove: функция, которая используется для передвижения игрока и ботов(кругов), с учётом коллизий.
...
Base.Character(Actor): класс, отвечающий за персонажий и инертность их перемещения.

Base.FirstPersonCharacter(Base.Character): класс, который представляет из себя базового персонажа, который может быть полезен в любой игре от первого лица, с реализованым перемещением и поворотом камеры.
...
LineTrace: функция, которая находит пересечения отрезка со всеми стенами.
